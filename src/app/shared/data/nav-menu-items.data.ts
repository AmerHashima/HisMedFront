// src\app\shared\data\nav-menu-items.data.ts
import type { Menu } from '../models/menu.model';

export const NAV_MENU_ITEMS: Menu[] = [
    {
      headTitle: 'Main',
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              title: 'level-2',
              path: '/level-menu/level-2/level-2-1',
              dirchange: false,
              type: 'sub',
              selected: false,
              children: [
                ...
                },
                {
                  ...
                  active: false,
                  selected: false,
                  path: '/level-menu/level-2/level-2-2',
                },
              ],
            },
          ],
